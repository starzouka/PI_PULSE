...
#[ORM\Table(
    ...
    indexes: [
        new ORM\Index(name: 'idx_treq_organizer', columns: ['organizer_user_id']),
        new ORM\Index(name: 'idx_treq_game', columns: ['game_id']),
        new ORM\Index(name: 'idx_treq_status', columns: ['status', 'created_at']),
        new ORM\Index(name: 'idx_treq_reviewed_by', columns: ['reviewed_by_admin_id']),
    ]
)]
class TournamentRequest
{
    ...
    #[ORM\Column(
        ...
        type: Types::STRING,
        length: 10,
        columnDefinition: "ENUM('OPEN','APPROVAL') NOT NULL DEFAULT 'OPEN'"
    )]
    ...
    #[ORM\Column(
        ...
        type: Types::STRING,
        length: 10,
        columnDefinition: "ENUM('PENDING','ACCEPTED','REFUSED') NOT NULL DEFAULT 'PENDING'"
    )]
